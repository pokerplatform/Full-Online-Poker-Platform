<%@ Page language="c#" Codebehind="BonusRules.aspx.cs" AutoEventWireup="false" Inherits="Admin.Misc.BonusRules" %>
					...
					<td align="center">
						<asp:Table ID="tblMain" CellSpacing="0" GridLines="Both" CellPadding="2" HorizontalAlign="Center"
							...
							<asp:TableRow CssClass="cssReportHeader">
								...
								<asp:TableCell Width="15%">Bonus</asp:TableCell>
