<%@ Page language="c#" Codebehind="MiscMaintenance.aspx.cs" AutoEventWireup="false" Inherits="Admin.Misc.MiscMaintenance" %>
...
<HTML>
	<HEAD>
		<title>Miscelaneous Maintenance</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="MiscMaintenance" method="post" runat="server">
			...
			<table width="100%" align="center">
				<tr>
					<td align="middle"><CBC:BUTTONIMAGE id="btnSave" onclick="btnSave_click" runat="server" Text="Save"></CBC:BUTTONIMAGE></td>
				</tr>
				<tr>
