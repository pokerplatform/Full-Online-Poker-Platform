...
<TABLE id=Table1 width="100%" height="100%" align=center border=0 >
  <TR>
    <TD align=middle><asp:label id=lblName runat="server"></asp:label></TD></TR>
  <TR>
  ...
  <TR>
    <TD align=middle><CBC:BUTTONIMAGE id=btnClose onclick=btnClose_click runat="server" CausesValidation="false" Text="Close"></CBC:BUTTONIMAGE></TD></TR></TABLE></form>
<script>
