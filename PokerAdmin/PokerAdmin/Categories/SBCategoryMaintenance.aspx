...
<%@ Page language="c#" Codebehind="SBCategoryMaintenance.aspx.cs" AutoEventWireup="false" Inherits="Admin.Categories.SBCategoryMaintenance" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>BuddyWager Category maintenance</title>
	...
	<body>
		<form id="SBCategory" method="post" runat="server">
					...
					<td align="center">
						...
						<asp:datagrid id="oGrid" runat="server" AutoGenerateColumns="False" CellSpacing="0" HorizontalAlign="Center"
							...
							<Columns>
								...
								<asp:BoundColumn HeaderStyle-Width="100" HeaderText="SubCategory Count" DataField="SubCategoryCount"></asp:BoundColumn>
