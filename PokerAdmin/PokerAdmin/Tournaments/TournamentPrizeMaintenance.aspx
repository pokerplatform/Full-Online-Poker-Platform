...
<%@ Page language="c#" Codebehind="TournamentPrizeMaintenance.aspx.cs" AutoEventWireup="false" Inherits="Admin.Tournaments.TournamentPrizeMaintenance" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Tournament Prize Maintenance</title>
				...
				<tr>
					<td align="center">
						<GFC:gridfilter id="oFilter" runat="server" MoveHeader="true" Grid="oGrid">
							...
							<GFC:FilterItem id="edt1" GridSourceParameter="@TournamentPrizeName" Type="Edit"></GFC:FilterItem>
						</GFC:gridfilter>
