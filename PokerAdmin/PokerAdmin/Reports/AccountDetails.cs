...
namespace Admin.Reports {
    ...
    public class AccountDetails : ReportClass {
    ...
    public class CachedAccountDetails : Component, ICachedReport {
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            AccountDetails rpt = new AccountDetails();
            rpt.Site = this.Site;
            return rpt;
        }
