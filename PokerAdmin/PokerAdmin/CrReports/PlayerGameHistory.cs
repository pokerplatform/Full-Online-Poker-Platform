...
namespace Admin.CrReports {
    ...
    public class PlayerGameHistory : ReportClass {
    ...
    public class CachedPlayerGameHistory : Component, ICachedReport {
        
        public CachedPlayerGameHistory() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PlayerGameHistory rpt = new PlayerGameHistory();
            rpt.Site = this.Site;
            return rpt;
        }
