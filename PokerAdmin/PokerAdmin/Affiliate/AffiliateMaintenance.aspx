<%@ Page language="c#" Codebehind="AffiliateMaintenance.aspx.cs" AutoEventWireup="false" Inherits="Admin.Affiliate.AffiliateMaintenance" %>
				...
				<tr>
					<td align="center">
						<GFC:GRIDFILTER id="oFilter" runat="server" Grid="oGrid" MoveHeader="true">
							...
							<GFC:FilterItem id="edt1" GridSourceParameter="@AffiliateName" Type="Edit"></GFC:FilterItem>
							<GFC:FilterItem id="Status" GridSourceParameter="@StatusID" Type="Combo" ComboSourceQuery="admGetDictionaryStatusAll"
								Cashed="true"></GFC:FilterItem>
							<GFC:FilterItem id="Skin" GridSourceParameter="@SkinID" Type="Combo" ComboSourceQuery="admGetDictionarySkins"
								Cashed="true"></GFC:FilterItem>
						</GFC:GRIDFILTER>
						<asp:datagrid id="oGrid" runat="server" AutoGenerateColumns="False" HorizontalAlign="Center" CellPadding="2"
							...
							<Columns>
								...
								<asp:HyperLinkColumn HeaderText="Affiliate Name"></asp:HyperLinkColumn>
								<asp:HyperLinkColumn HeaderText="Status" HeaderStyle-Width="30%"></asp:HyperLinkColumn>
								<asp:HyperLinkColumn HeaderText="Skin" HeaderStyle-Width="30%"></asp:HyperLinkColumn>
							</Columns>
