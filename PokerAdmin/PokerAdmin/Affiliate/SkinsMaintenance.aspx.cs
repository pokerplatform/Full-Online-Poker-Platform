...
namespace Admin.Affiliate
{
	...
	/// </summary>
	public class SkinsMaintenance : Components.MaintenancePage
	{
		...
		protected override  void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				Session["SkinsMaintenanceUrl"]=Request.Url.AbsoluteUri;   
			}
		}



		public SkinsMaintenance()
		{
			nEditPageNum     = Config.PageSkinsDetails;
			sDbDeleteQuery   = Config.DbDeleteSkin;
			sGridSourceQuery = Config.DbGetSkinsList;
		}
