...
//	arrSitCrd = new Array (new Array (581, 48), new Array (721, 126), new Array (737, 265), new Array (670, 375), new Array (510, 408), new Array (280, 408), new Array (120, 375), new Array (49, 265), new Array (68, 126), new Array (208, 48));
	arrSitCrd = new Array (new Array (581, 48), new Array (721, 126), new Array (737, 260), new Array (670, 380), new Array (510, 408), new Array (280, 408), new Array (120, 375), new Array (49, 265), new Array (68, 126), new Array (208, 48));
	if (objTable.pokerType == 4 || objTable.pokerType == 5){
		arrSitCrd = new Array (new Array (581, 68), new Array (721, 126), new Array (737, 260), new Array (670, 380), new Array (510, 408), new Array (280, 408), new Array (120, 375), new Array (49, 265), new Array (68, 126), new Array (208, 68));
	}
...
{
	trace ("version::"+xmlPlayer.attributes.userimageversion)
	...
	var userImageVersion = (xmlPlayer.attributes.userimageversion != undefined) ? Number (xmlPlayer.attributes.userimageversion) : 0;
	//
	arrSits[numSit]._visible = true;
	arrSits[numSit].setUserId (userId);
	arrSits[numSit].setPlayerProperty (userName, userCity, userSex, userAvatar, userImageVersion);
